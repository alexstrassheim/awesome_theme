...
if screen.count() < 2 then
    tags = {
        names = { "[1:TERM]", "[2:WEB]", "[3:MEDIA]", "[4:OTHER]"},
        layout = { layouts[4], layouts[2], layouts[3], layouts[4] }
    }
    for s = 1, screen.count() do
        tags[s] = awful.tag(tags.names, s, tags.layout)
    end
    ...
    tags = {
        settings = {
            { names = { "[1:TERM]", "[2:APP]", "[3:OFFICE]", "[4:CHAT]" },
              layout = { layouts[4], layouts[2], layouts[3] , layouts[4]}
            },
            { names = { "[1:MAIL]", "[2:WEB]", "[3:FILE]", "[4:WIN]" },
              layout = { layouts[4], layouts[2], layouts[3], layouts[4]}
            }
        }
    }
...
mytasklist.buttons = awful.util.table.join(
                     ...
                     awful.button({ }, 3, function ()
                                              if instance then
                                                  ...
                                                  instance = awful.menu.clients({theme = { height = 25, width = 400 }})
                                              end
                                          end),
