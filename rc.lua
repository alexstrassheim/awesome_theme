...
-- user defined
browser    = "firefox"
browserP    = "firefox --no-remote -P Pentest"
gui_editor = "gvim"
graphics   = "gimp"
...
--    layout = { layouts[3], layouts[2], layouts[3], layouts[4] }
-- }
--
...
mytasklist.buttons = awful.util.table.join(
                     ...
                     awful.button({ }, 3, function ()
                                              if instance then
                                                  ...
                                                  instance = awful.menu.clients({theme = { height = 26, width = 350 }})
                                              end
                                          end),
...
for s = 1, screen.count() do
    ...
    mywiboxbottom[s] = awful.wibox({ position = "bottom", screen = s, height = 30 })
...
globalkeys = awful.util.table.join(
    -- Take a screenshot
     awful.key({ altkey }, "p", function() os.execute("scrot 'Screenshot_%Y-%m-%d_%H%M%S.png' -e 'mv $f ~/screenshots/'") end),
    ...
    awful.key({ altkey,           }, "Tab",    function () awful.menu.clients({theme = { height = 35, width = 350 }}) end),
    ...
    awful.key({ altkey, "Control" }, "m",
        function ()
            os.execute(string.format("amixer set %s 60%%", volumewidget.channel))
            volumewidget.update()
        end),
    awful.key({ altkey, "Shift" }, "m",
        function ()
            os.execute(string.format("amixer set %s 20%%", volumewidget.channel))
            volumewidget.update()
        end),
